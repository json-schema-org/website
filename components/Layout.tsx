...
export default function Layout({
  ...
  return (
    <div className='min-h-screen fixed inset-0 w-full overflow-y-scroll flex flex-col justify-betweenn'>
      <FaviconHead />
      <Head>
      ...
      <div className={classnames({ 'bg-white': whiteBg })}>
        ...
        >
          <header
            className={classnames(
              'w-screen fixed bg-white fixed top-0 z-[170] shadow-xl drop-shadow-lg',
            )}
          >
...
const MobileNav = () => {
  ...
  return (
    <div className='flex flex-col justify-end fixed shadow-xl bg-white w-full  z-[190] top-16 left-0 pl-8'>
      <MainNavLink
        uri='/specification'
        label='Specification'
        isActive={section === 'specification'}
