...
const MainNavigation = () => {
  ...
  useEffect(() => {
    ...
    const keyShadow = theme === 'dark' ? 'inset 0 -2px 0 0 #ffffff, inset 0 0 1px 1px #ffffff, 0 2px 2px 0 rgba(3, 4, 9, 0.3)' : 'inset 0 -2px 0 0 #cdcde6,inset 0 0 1px 1px #fff,0 1px 2px 1px rgba(30,35,90,0.4)';
