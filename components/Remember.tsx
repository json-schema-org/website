    ...
    return (
      ...
      <div className='mt-2 mb-2'>
        <ol className='list-decimal mt-2 mb-4 ml-5'>
          <li className='mt-1 leading-7'>Familiarize yourself with our project's <a className='underline' rel='noreferrer' href="https://github.com/json-schema-org/community/blob/main/CONTRIBUTING.md">Contribution Guide</a> and our <a className='underline' rel='noreferrer' href="https://github.com/json-schema-org/.github/blob/main/CODE_OF_CONDUCT.md">Code of Conduct</a>.</li>
          <li className='mt-1 leading-7'>Head over to our <a className='underline' rel='noreferrer' href="https://github.com/orgs/json-schema-org/projects/16">JSON Schema Docs Board</a>.</li>
          <li className='mt-1 leading-7'>Pick an issue you would like to contribute to and leave a comment introducing yourself. This is also the perfect place to leave any questions you may have on how to get started.</li>
          <li className='mt-1 leading-7'>If there is no work done in that Docs issue yet, feel free to open a PR and get started!</li>
        </ol>
      </div>
