        ...
        <div>
          ...
          {!feedbackStatus &&
            <div className='my-6 text-base'>
              <form className='flex flex-col' onSubmit={createFeedbackHandler} ref={feedbackFormRef}>
                <div className='mb-6'>
                  ...
                  <label className='px-[16px] py-[8px] cursor-pointer border-solid border-[#aaaaaa] border rounded-md peer-checked/feedback-survery-yes:bg-[#1f6feb] peer-checked/feedback-survery-yes:text-white hover:bg-gray-200' htmlFor='feedback-survey-yes' onClick={() => { setIsFormOpen(true) }}>
                    <svg className='inline-block select-none overflow-visible' aria-hidden='true' focusable='false' role='img' viewBox='0 0 16 16' width='16' height='16' fill='currentColor'>
                  ...
                  <label className='px-[16px] py-[8px] cursor-pointer border-solid border-[#aaaaaa] border rounded-md mx-2 peer-checked/feedback-survery-no:bg-[#da3633] peer-checked/feedback-survery-no:text-white hover:bg-gray-200' htmlFor='feedback-survey-no' onClick={() => { setIsFormOpen(true) }}>
                    <svg className='inline-block select-none overflow-visible' aria-hidden='true' focusable='false' role='img' viewBox='0 0 16 16' width='16' height='16' fill='currentColor'>
