  ...
  return (
    <div className='flex flex-col rounded-md shadow-md border border-gray-200 p-4 mt-16'>
      ...
      <div className='mt-2 mb-2'>
        Learning JSON Schema is often confusing, but don't worry, we are here to help! You can start a thread on <a target='_blank' className='underline' rel='noreferrer' href='https://github.com/json-schema-org/community/discussions/new?category=q-a'>GitHub Discussions</a>, connect with us on <a target='_blank' rel='noreferrer' className='underline' href='https://app.slack.com/client/T5CHC2TAN/C5CF75URH'>Slack</a>, or join our live <a target='_blank' rel='noreferrer' className='underline' href='https://github.com/json-schema-org/community/discussions/34'>Office Hours</a>.
      </div>
