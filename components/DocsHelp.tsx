  ...
  const feedbackButtons = [
    {
      ...
      className:
        'peer-checked/feedback-survery-yes:bg-[#1f6feb] peer-checked/feedback-survery-yes:text-white',
      icon: (
    ...
    },
    {
      ...
      className:
        'peer-checked/feedback-survery-no:bg-[#da3633] peer-checked/feedback-survery-no:text-white',
      icon: (
