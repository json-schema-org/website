...
export default function FeatureSection() {
  return (
    <section className='w-5/6 lg:w-3/5 mt-[100px]'>
      ...
      {/* Feature 4 section*/}
      <div className='w-full grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-12 content-center my-[85px] mr-12 mt-4'>
        <div className=' flex mb-4'>
          <div className='hidden md:block'>
            <img src='/img/home-page/easy-and-reliable-data-exchange-icon.svg' className='h-[124px] w-[124px] mr-12 mt-4' />
          </div>
        ...
        <div className=' flex mb-4'>
          <div className='hidden md:block'>
            <img src='/img/home-page/testing-validation-icon.svg' className=' h-[144px] w-[144px] mr-12 mt-4' />
          </div>
          <div className='w-full lg:w-[334px]'>
