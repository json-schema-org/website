            ...
            {contractorData.map((contractor) => (
              ...
              >
                <h1 className='text-xl mb-3 font-semibold'>
                  {contractor.name}
                  <span className='ms-4 border border-gray-200 text-base uppercase bg-zinc-200 dark:bg-zinc-800 px-2 py-1 rounded'>
                    {contractor.type}
                  </span>
                </h1>
                <div>
                  ...
                  {contractor.linkedin && (
                    ...
                    >
                      <svg
                        ...
                        strokeWidth={1.5}
                        stroke='currentColor'
                        className='w-5 inline-block me-1 dark:fill-white'
                      >
                ...
                <div className='flex mt-3 max-sm:flex max-sm:flex-col max-sm:gap-2 '>
                  <div className='me-4 max-sm:flex max-sm:flex-col max-sm:items-center max-sm:gap-2'>
                    ...
                    <a
                      ...
                      className='text-center mt-3 mb-2 block px-4 py-1 text-sm text-blue-700 font-semibold border border-blue-700 hover:text-white hover:bg-blue-700 hover:border-transparent focus:outline-none focus:ring-2 focus:ring-blue-700 focus:ring-offset-2 max-sm:px-16 dark:border-white dark:text-white'
                    >
                      Reach out
                    </a>
                  </div>
