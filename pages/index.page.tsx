...
'>Contribute</a></button>
        ...
        <section className='my-20'>
          ...
          <div className='flex justify-center items-center'>
            <a href='https://orbit.love/' ><img src='/img/logos/supported/orbit-logo-color.png' className='w-44 mr-8 sc:ml-2' /></a>
            <a href='https://json-schema.slack.com/join/shared_invite/zt-1ywpdj4yd-bXiBLjYEbKWUjzon0qiY9Q#/shared-invite/email' ><img src='/img/logos/supported/slack-logo.svg' className='w-44 ml-8 sc:mr-2' /></a>
          </div>
        </section>
      </div>
    </div>
