...
'>Contribute</a></button>
        ...
        <section className='my-20'>
          <div className='text-center mb-12'>
            ...
            <p className='px-22 mx-auto'>The following companies support us by letting us use their products.<br /><a href='mailto:ben@jsonschema.dev' className='border-b border-black'>Email us</a> for more info!</p>
          </div>
