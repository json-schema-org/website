          ...
          <div className='max-w-[1400px] text-center mx-auto mt-24 lg:mt-40'>
            ...
            <div className='lg:w-[650px]  mx-auto my-10 grid grid-cols-1 lg:grid-cols-3 gap-8 justify-items-center'>
              <Link
                ...
                className='pt-1 rounded border-2 border-white text-white w-[194px] h-[40px] font-semibold'
              >
                Getting started
              </Link>
              <Link
          ...
          <div className='flex flex-col items-center md:flex-row justify-center text-center'>
            <a href='https://www.commonroom.io'>
              <img
                ...
                className='w-44 max-h-[58px] mb-4 md:mb-0 md:mr-8 md:ml-2'
              />
            </a>
            <a href='https://json-schema.org/slack'>
              <img
                src='/img/logos/supported/slack-logo.svg'
                className='w-44 mt-4 md:mt-0 md:ml-8 md:mr-2'
              />
            </a>
          </div>
        </section>
