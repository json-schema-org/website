      ...
      <div className='flex flex-col items-center'>
        ...
        <section className='bg-[linear-gradient(72.68deg,_#002CC4_28.97%,_#5468FF_145.47%)] clip-bottom w-full dark:bg-[linear-gradient(72.68deg,_#002C34_28.97%,_#5468FF_145.47%)]'>
          <div className='max-w-[1400px] text-center mx-auto mt-24 lg:mt-40'>
            ...
            <div className='lg:w-[650px]  mx-auto my-10 grid grid-cols-1 lg:grid-cols-3 gap-8 justify-items-center '>
              <Link href='/learn/getting-started-step-by-step' className='pt-1 rounded border-2 border-white text-white w-[194px] h-[40px] font-semibold dark:border-none dark:shadow-2xl'>Getting started</Link>
              <Link href='/slack' className='pt-1 rounded border-2 border-white text-white  w-[194px] h-[40px] font-semibold dark:border-shadow-white dark:border-none dark:shadow-2xl'>Join Slack</Link>


              <div className='herobtn rounded border-2 border-white text-white mx-auto dark:border-none dark:shadow-2xl'>
                <DocSearch
                  appId='6ZT4KX2OUI'
            ...
            <div className='mb-16 md:mb-36  mx-auto w-full md:w-5/6 lg:w-full'>
              ...
              <p className='text-white mx-4 my-5 dark:text-slate-400'>Please visit the official list of <a className='underline' href='https://github.com/json-schema-org/community/blob/main/ADOPTERS.md'>adopters</a> and discover more companies using JSON Schema.</p>
            </div>
          </div>
        </section>
        {/* Feature */}
        <section className='max-w-[1400px] mt-12 lg:mt-[80px]'>
          ...
          <div className='w-5/6 lg:w-3/5 grid grid-cols-1 md:grid-cols-2 gap-6   my-[85px] mx-auto '>
            <div className='w-full  shadow-3xl  rounded-[10px] p-[20px] dark:shadow-slate-700'>
              <h3 className='text-h5mobile md:text-h5 font-semibold mb-6 dark:text-slate-200'>Streamline testing and validation</h3>
              <p className='dark:text-slate-300'>Simplify your validation logic to reduce your code’s complexity and save time on development. Define constraints for your data structures to catch and prevent errors, inconsistencies, and invalid data.</p>
            </div>
            <div className='w-full  shadow-3xl  rounded-[10px] p-[20px] dark:shadow-slate-700'>
              <h3 className='text-h5mobile md:text-h5 font-semibold mb-6 dark:text-slate-200'>Exchange data seamlessly</h3>
              <p className='dark:text-slate-300'>Establish a common language for data exchange, no matter the scale or complexity of your project. Define precise validation rules for your data structures to create shared understanding and increase interoperability across different systems and platforms.</p>
            </div>
            <div className='w-full  shadow-3xl  rounded-[10px] p-[20px] dark:shadow-slate-700'>
              <h3 className='text-h5mobile md:text-h5 font-semibold mb-6 dark:text-slate-200 '>Document your data</h3>
              <p className='dark:text-slate-300'>Create a clear, standardized representation of your data to improve understanding and collaboration among developers, stakeholders, and collaborators.</p>
            </div>
            <div className='w-full  shadow-3xl  rounded-[10px] p-[20px] dark:shadow-slate-700'>
              <h3 className='text-h5mobile md:text-h5 font-semibold mb-6 dark:text-slate-200'>Vibrant tooling ecosystem</h3>
              <p className='dark:text-slate-300'>Adopt JSON Schema with an expansive range of community-driven tools, libraries, and frameworks across many programming languages.</p>
            </div>
          </div>
        </section>
        ...
        <section className='w-full h-[300px] lg:h-[367px] bg-gradient-to-r from-primary from-1.95% to-endBlue clip-both dark:from-[#002C34] dark:to-[#023e8a]'>
          <div className='lg:w-full mx-auto text-center mt-28 '>
            ...
            <button className='w-[170px] h-[45px] mx-auto rounded border-2 bg-primary text-white font-semibold dark:bg-[560bad] dark:border-none'><a href='/learn/getting-started-step-by-step '>Read the docs</a></button>
          </div>
        </section>
        ...
        <section className='max-w-[1400px] w-full lg:flex lg:gap-20 my-16 '>
          ...
          <div className='w-5/6 md:w-3/5 mx-auto mt-12' >
            <h3 className=' text-center lg:text-left text-h3mobile md:text-h3 font-semibold mb-4 dark:text-slate-200'>Explore the JSON Schema Ecosystem</h3>
            ...
            <button className='w-full md:w-1/2 md:ml-28 lg:ml-0 mx-auto  h-[45px] rounded border-2 bg-primary text-white dark:border-none'><a href='/implementations/'>Explore</a></button>
        ...
        <section className='lg:my-12 max-w-[1400px]'>
          <div className='mb-12 md:w-3/4  mx-auto text-center'>
            <h2 className='text-h3mobile md:text-h3 font-semibold mb-2 dark:text-slate-200'>Welcome to the JSON Schema Community</h2>
            <p className='mx-6 md:w-3/4 md:mx-auto  lg:text-h5 dark:text-slate-300'>With over 60 million weekly downloads, JSON Schema has a large and active developer community across the world. Join the Community to learn, share ideas, ask questions, develop JSON Schema tooling and build new connections.
            </p>
          </div>
          <div className='grid grid-cols-1 lg:grid-cols-3 gap-6 mb-12 mx-auto w-5/6 md:w-3/5 lg:w-5/6'>
            <div className='w-full mb-6 dark:shadow-2xl'>
              <Link href='https://json-schema.org/slack'>
                <h3 className='mb-4 font-semibold flex items-center dark:text-slate-200' >Join the JSON Schema Slack Workspace!<img src='/img/logos/Slack-mark.svg' className='w-8 h-8' /></h3>
                <img src='/img/home-page/slack-json-schema.png' className='w-full mb-4' />
                {/* <h3 className='mb-4 font-semibold' >Event</h3> */}
                <p className='mb-4 dark:text-slate-300'>Join our Slack to ask questions, get feedback on your projects, and connect with +5000 practitioners and experts.</p>
              </Link>
              <button className='w-full lg:w-1/2 rounded border-2 bg-primary text-white h-[40px] flex items-center justify-center dark:border-none '><a href='https://json-schema.org/slack' className='flex items-center '><img src='/img/logos/slack_logo_small-white.svg' className='w-4 h-4 mr-2 ' />Join Slack</a></button>
            </div>
            {/* BlogPost Data */}
            <div className='w-full mb-6 dark:shadow-2xl'>
              <Link href={`/blog/posts/${blogPosts[0].slug}`}>
                <h3 className='mb-5 font-semibold pt-1 dark:text-slate-200' >The JSON Schema Blog</h3>
                <img src={blogPosts[0].frontmatter.cover} className='w-full h-[232px]  mb-4' />
                <h3 className='mb-4 font-semibold dark:text-slate-300' > {blogPosts[0].frontmatter.title}</h3>
            ...
            <div>
              <div className='md:w-full mb-6 mr-4 dark:shadow-2xl'>
                <h3 className='mb-2 font-semibold dark:text-slate-200' >JSON Schema Community Meetings & Events</h3>
                <p className='mb-4 dark:text-slate-300'>We hold monthly Office Hours and weekly Open Community Working Meetings. Office Hours are every first Tuesday of the month at 15:00 BST, and by appointment. Open Community Working Meetings are every Monday at 14:00 PT.
                </p>
                <div className=''>
                  <button className='max-w-[300px] w-full text-center rounded border-2 bg-primary text-white  h-[40px] mb-4 flex items-center justify-center dark:border-none '><a href='https://github.com/orgs/json-schema-org/discussions/35' >Open Community Working Meetings</a></button>
                  <button className='max-w-[200px] w-full text-center rounded border-2 bg-primary text-white  h-[40px] flex items-center justify-center dark:border-none '><a href='https://github.com/orgs/json-schema-org/discussions/34/'
        ...
        <section className='w-full h-[300px] lg:h-[367px] bg-gradient-to-r from-primary from-1.95% to-endBlue clip-both dark:from-[#002C34] dark:to-[#023e8a]'>
          <div className='lg:w-full mx-auto text-center mt-28 '>
            <h2 className='text-h3mobile lg:text-h3 text-white mb-6 dark:text-slate-200'>Start contributing to JSON Schema</h2>
            <button className='w-[170px] h-[45px] mx-auto rounded border-2 bg-primary text-white font-semibold dark:border-none '><a href='https://github.com/json-schema-org#-contributing-to-json-schema'>Contribute</a></button>
          </div>
        </section>
        ...
        <section className='my-16'>
          <div className='text-center mb-12'>
            <h2 className='text-h3mobile md:text-h3 font-semibold mb-2 dark:text-slate-200'>Sponsors</h2>
            <p className='w-5/6 lg:w-3/5 mx-auto dark:text-slate-300'>If you ❤️ JSON Schema consider becoming a <a href='https://opencollective.com/json-schema/contribute' className='border-b border-black'>sponsor</a> or a <a href='https://opencollective.com/json-schema/contribute' className='border-b border-black '>backer</a>.</p>
