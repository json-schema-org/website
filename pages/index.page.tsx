...
'>Contribute</a></button>
        ...
        <section className='my-16'>
          ...
          <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-12 mx-auto md:mx-0 px-4'>
        ...
        <section className='my-20'>
          ...
          <div className='grid grid-cols-2 md:gap-24 items-center mx-auto w-3/4 md:w-3/5 lg:w-1/2'>
            <a href='https://orbit.love/'><img src='/img/logos/supported/new-orbit-logo-color.svg' className=' w-64' /></a>
            <a href='https://json-schema.slack.com/join/shared_invite/zt-1ywpdj4yd-bXiBLjYEbKWUjzon0qiY9Q#/shared-invite/email'><img src='/img/logos/supported/slack-logo.svg' className=' w-64' /></a>
          </div>
        </section>
      </div>
    </div>
