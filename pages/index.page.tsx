...
'>Contribute</a></button>
        ...
        <section className='my-20'>
          ...
          <div className='flex justify-center items-center'>
            <a href='https://orbit.love/'><img src='/img/logos/supported/new-orbit-logo-color.svg' className=' w-44 h-auto mr-4' /></a>
            <a href='https://json-schema.slack.com/join/shared_invite/zt-1ywpdj4yd-bXiBLjYEbKWUjzon0qiY9Q#/shared-invite/email'><img src='/img/logos/supported/slack-logo.svg' className=' w-44 h-auto mr-4' /></a>
          </div>
        </section>
      </div>
    </div>
