...
For now, the JSON Schema TSC are watching the various threads that come through the IETF mailing list.  So far, a JSON Schema Working Group Charter has been produced, and Lisa has created an initial draft for a proposal.
