...
All of the published JSON Schema were done so as IETF Internet Drafts.  IETF uses these I-Ds as a first step in the process toward official RFCs.  In effect, they are specification proposals.  
...
After 2020-12 was released, the team began looking toward other publication options.  In recent years, we had considered joining the OpenJS Foundation, part of the Linux Foundation, and even ECMA International.  However those efforts never proved fruitful for various reason that I won't get into here.
...
I introduce them to the rest of the team, and we've been in periodic discussions since.

## The Plan Forward

For right now, the JSON Schema TSC are watching the various thread that come through the IETF mailing list.  So far, a JSON Schema Working Group Charter has been produced, and an initial draft of a proposal has been created.
