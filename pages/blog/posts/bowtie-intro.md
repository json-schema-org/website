...
From the existing [list of JSON Schema implementations](https://json-schema.org/tools#validators), Bowtie already [supports](https://github.com/orgs/bowtie-json-schema/packages) _12_ implementations across _9_ programming languages, allowing anyone to run any of these implementations and see what they have to say about schemas and instances.
