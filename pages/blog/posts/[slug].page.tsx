...
=======
                <Link
                  href='/blog'
                  className='font-semibold text-sm pb-0 lg:pb-5 text-slate-700 hover:text-slate-800 dark:text-slate-300 dark:hover:text-slate-400  inline-flex flex-row items-center'
                >
