                ...
                {imageData
                  ...
                  .map((avatar, index) => (
                    <Image
                      ...
                      quality={75}
                      className='sm:w-[40px] md:w-[45px] lg:w-[50px] sm:h-[40px] md:h-[45px] lg:h-[50px] rounded-full border-black transition-all duration-200 hover:scale-110 hover:ring-2 hover:ring-blue-500'
                    />
                  ))}
              </div>
            </div>
