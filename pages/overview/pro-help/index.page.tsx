      ...
      >
        <div>
          ...
          <p className='italic'>
            ...
            <a href='https://www.openapis.org' className='underline' target='_blank' rel='noopener noreferrer'>
              OpenAPI
            </a>
            ,
          ...
          <br />
          <span className='font-bold text-[1.3rem] text-gray-800 dark:text-gray-200'>
            Available Members
          </span>
                  ...
                  <ul className='grid gap-4'>
                    {contractor.links.map((link) => (
                      ...
                      >
                        ...
                        <a
                          href={link.url}
                          className='text-blue-500 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 transition-colors font-semibold break-words'
                        >
                          {link.title}
                        </a>
                      </li>
