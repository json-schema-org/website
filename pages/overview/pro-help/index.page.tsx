        ...
        <div>
          ...
          <div className="my-8 space-y-6">
            {contractorData.map((contractor) => (
              <div className="border border-solid border-gray-200 rounded-xl p-6 hover:shadow-xl transition-all duration-300 dark:border-gray-700 dark:bg-gray-800 bg-gradient-to-br from-white to-blue-50 dark:from-gray-800 dark:to-gray-900" key={contractor.github}>
                  ...
                  <div className="flex items-center space-x-8 pr-8 border-r border-gray-200 dark:border-gray-700">
                    <div className="relative group">
                      <img
                        ...
                        className="w-32 h-32 rounded-full border-4 border-blue-100 shadow-lg hover:border-blue-300 transition-all duration-300 dark:border-gray-600"
