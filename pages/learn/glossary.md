...
Whether something that otherwise _appears_ to be a schema (based on its contents) actually _is_ a subschema can be misleading at first glance without context or knowlege about its location within the parent schema.
