...
const AmbassadorBanner: React.FC = () => {
  return (
    <div className='flex justify-center mx-4 md:mx-10 my-8 w-full'>
      <div className='group relative h-auto md:w-5/6 lg:w-2/3 xl:w-1/2 rounded-lg border border-gray-200 bg-white p-6 px-12 shadow-3xl dark:shadow-2xl dark:shadow-slate-900 transition-colors ease-in-out hover:bg-slate-100 dark:bg-slate-800 hover:dark:bg-slate-900/30'>
